        ...
        <>
            {filteredMovie !== undefined &&
                <>
                    ...
                    {filteredMovie.backdrop === null || filteredMovie.backdrop === undefined
                        ? ''
                                    ...
                                    <ImageSection.FlexFrame>
                                        ...
                                        <Grid.Col size={1} breakPoint='md' >
                                            <ImageSection.ThumbContainer>
                                                {filteredMovie.poster === null || filteredMovie.poster === undefined
                                                    ? <img src={'https://via.placeholder.com/349x524'} alt={filteredMovie.title} />
